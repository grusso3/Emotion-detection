...
from Classes import EmotionDataTest,Network, Network2, EmotionData
...
model11.load_state_dict(torch.load("saved_models/VGG16e-4_VGG16e-4_8082.pt", map_location=torch.device('cpu')),strict= False)
...
# labels, title and ticks
ax.set_xlabel('Predicted labels');ax.set_ylabel('True labels');
ax.set_title('Confusion Matrix VGG11');
ax.xaxis.set_ticklabels(['angry', 'disgust', 'fear',"happy","neutral","sad","surprise"]); ax.yaxis.set_ticklabels(['angry', 'disgust', 'fear',"happy","neutral","sad","surprise"]);
plt.show()
...
model1 = Network()
model1.load_state_dict(torch.load("saved_models/EmotionData_EmotionData_1796.pt", map_location=torch.device('cpu')),strict= False)
...
# labels, title and ticks
ax.set_xlabel('Predicted labels');ax.set_ylabel('True labels');
ax.set_title('Confusion Matrix CNN1');
ax.xaxis.set_ticklabels(['angry', 'disgust', 'fear',"happy","neutral","sad","surprise"]); ax.yaxis.set_ticklabels(['angry', 'disgust', 'fear',"happy","neutral","sad","surprise"]);
plt.show()
