...
# Add checkpoint
checkpointer = ModelCheckpoint('saved_models', 'VGG11', n_saved=2, create_dir=True, save_as_state_dict=True, require_empty=False)
trainer.add_event_handler(Events.EPOCH_COMPLETED, checkpointer, {'VGG11e-4': model})
